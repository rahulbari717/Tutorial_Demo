...
extern const uint8_t server_cert_pem_start[] asm("_binary_google_com_pem_start");
    ...
    while (true)
    {
        ...
        ESP_ERROR_CHECK(nvs_flash_init()); /*
         ...
         esp_http_client_config_t clientConfig = {
             .url = "https://drive.usercontent.google.com/u/1/uc?id=1dCCWpHuCdg2F4pl5M4WoX-L9AxAfMaX4&export=download", // our ota location
